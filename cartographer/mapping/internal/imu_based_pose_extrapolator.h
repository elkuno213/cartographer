...
private:
  ...
  std::deque<::cartographer::transform::TimestampedTransform> timed_pose_deque_;
  std::deque<::cartographer::transform::TimestampedTransform>
    previous_solution_deque_;

  std::deque<sensor::ImuData> imu_data_deque_;
  std::deque<sensor::OdometryData> odometry_data_deque_;
