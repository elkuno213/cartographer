...
public:
  ...
  virtual void AddImuData(int trajectory_id, const sensor::ImuData& imu_data)
    = 0;
  ...
  virtual void AddFixedFramePoseData(
    int trajectory_id, const sensor::FixedFramePoseData& fixed_frame_pose_data
  ) = 0;
  ...
  virtual void AddSubmapFromProto(
    const transform::Rigid3d& global_pose, const proto::Submap& submap
  ) = 0;
